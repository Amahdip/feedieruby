...
import { UNSUPPORTED_FEEDBACK_SOURCE_ELEMENT_TYPES } from "@salamruby/types/feedback-source";
import { getTSurveyElementTypeEnumName } from "@/modules/survey/lib/elements";
import { Checkbox } from "@/modules/ui/components/checkbox";
import { Label } from "@/modules/ui/components/label";
import { TUnifySurvey } from "../types";

interface SalamRubyQuestionListProps {
...
export const SalamRubyQuestionList = ({
  survey,
  selectedQuestionIds,
  onQuestionToggle,
}: Readonly<SalamRubyQuestionListProps>) => {
