        ...
        links={[
          {
            ...
            href: "https://salamruby.com/docs/xm-and-surveys/surveys/website-app-surveys/advanced-targeting",
          },
          {
            title: t("workspace.surveys.share.dynamic_popup.code_no_code_triggers"),
            href: "https://salamruby.com/docs/xm-and-surveys/surveys/website-app-surveys/actions",
          },
          {
            title: t("workspace.surveys.share.dynamic_popup.recontact_options"),
            href: "https://salamruby.com/docs/xm-and-surveys/surveys/website-app-surveys/recontact",
          },
        ]}
      />
    </div>
