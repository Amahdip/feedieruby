...
To understand and bolster our security stature, SalamRuby undertakes:
...
- A potential security vulnerability in SalamRuby is identified.
- There is uncertainty about how a vulnerability affects our platform.
- A vulnerability is detected in a dependent project of SalamRuby.
...
- Assistance is needed to optimize SalamRuby for security – please engage on Github Discussions for this.
...
1. **Send a Detailed Report**:
   - Raise a security report on [Github](https://github.com/salamruby/salamruby/issues/new/choose) or send an email to [security@salamruby.com](mailto:security@salamruby.com).
   - Include:
     - Problem description.
...
We, at SalamRuby, wish to express our gratitude towards all individuals who assist us in fortifying our security posture. Your responsible disclosure and cooperation enable us to elevate our security protocols, safeguarding our platform and data therein.
