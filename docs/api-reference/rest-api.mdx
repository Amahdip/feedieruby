...
icon: "code"
description: "
SalamRuby provides two APIs: the Public Client API for frontend survey interactions and the Management API for backend management tasks."
---

SalamRuby offers two types of APIs: the **Public Client API** and the **Management API**. Each API serves a different purpose, has *different* authentication requirements, and provides access to different data and settings.
...
The **Management API** gives full access to all data and settings available in your SalamRuby account. It requires a personal API Key for authentication, which you can generate and manage in the Settings section of the SalamRuby app.
