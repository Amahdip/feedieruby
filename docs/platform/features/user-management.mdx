...
description: "Manage organization members, roles, teams, and security settings to control access and collaboration in your SalamRuby organization."
icon: "user"
---

SalamRuby provides comprehensive user management capabilities to help you control access, organize teams, and secure your organization. This section covers everything you need to know about managing users, roles, and permissions.

## Key concepts

SalamRuby uses a flexible permission system with multiple layers:
...
<CardGroup cols={2}>
  ...
  <Card title="Organizations and roles" icon="building" href="/xm-and-surveys/core-features/user-management/organizations-and-roles">
    Learn about organization-level roles and how they control access to teams, Workspaces, and data across your SalamRuby organization.
  </Card>
