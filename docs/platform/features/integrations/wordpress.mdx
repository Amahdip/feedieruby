---
title: "Wordpress"
description: "Target specific visitors with a survey on your WordPress page using SalamRuby for free. Show survey on specific page or on button click."
---

To run a targeted survey on your WordPress website, SalamRuby is the way to go!&#x20;
...
1. Install the SalamRuby WordPress plugin

2. Create a [free SalamRuby account](https://app.salamruby.com/auth/signup)
...
## Step 1: Install the SalamRuby WordPress plugin

As long as the SalamRuby plugin is in review, please download it from our [GitHub repository directly.](https://github.com/salamruby/wordpress)
...
## Step 2: Create a SalamRuby Account

This is super straight forward: Go to [app.salamruby.com/auth/signup](https://app.salamruby.com/auth/signup), create the account, verify your email and you’re in!
...
In your WordPress instance, go to the SalamRuby Plugin settings and copy the workspaceId in the correct field:
...
If you have any questions or need help, feel free to reach out to us on [Github Discussions](https://github.com/salamruby/salamruby/discussions)
