---
title: "AI Features"
description: "How AI features are organized, hosted, and controlled in SalamRuby."
icon: "sparkles"
---
...
SalamRuby ships a single organization-wide toggle that turns on AI-powered helpers across the app:
...
We prioritize self-hosted AI, especially for capabilities that process customer feedback data. SalamRuby supports
...
- **Current Embeddings model**: Alibaba GTE embeddings hosted by SalamRuby in Germany.
...
- **[AI Chart Creation](/unify-feedback/dashboards-charts#ai-builder)**:
  describe a chart in natural language and SalamRuby generates the underlying query.
