...
Add new members to your SalamRuby organization to collaborate on surveys and manage Workspaces together. You can invite members individually or in bulk using CSV uploads.
...
1. SalamRuby sends an email to the organization member with an invitation link
...
- SalamRuby sends an email to each organization member in the CSV
