...
description: "Understand organization-level roles and how they control access to teams, Workspaces, and data across your SalamRuby organization."
icon: "building"
---

Organization-level roles apply to all teams and Workspaces within your SalamRuby organization. These roles provide broad permissions that determine what users can do across the entire organization.
