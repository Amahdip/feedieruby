...
<Note>
  **Self-Hosting Requirements**: Uploading custom organization logos for emails requires file upload storage
  to be configured. If you're self-hosting SalamRuby, make sure to [configure file
...
<Note>Email branding is part of the SalamRuby [Enterprise Edition](/self-hosting/advanced/license).</Note>
