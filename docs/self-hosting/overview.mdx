---
title: "Self-Hosting"
description: "Learn how to self-host SalamRuby."
icon: "server"
---
...
* [**One-Click Setup**](/self-hosting/setup/one-click)**:** Set up SalamRuby on Ubuntu in minutes with our shell script.

* [**Docker Setup**](/self-hosting/setup/docker)**:** Use our pre-built Docker image for an effortless start.

* [**Migration Guide**](/self-hosting/advanced/migration)**:** Upgrade your existing SalamRuby instance smoothly.

* [**Configuration**](/self-hosting/configuration)**:** Customize your setup with advanced configurations.

* [**Integrations**](/self-hosting/configuration/integrations)**:** Connect SalamRuby to third-party tools.

* [**Licensing**](/self-hosting/advanced/license)**:**  Learn more about our AGPL SalamRuby Core and its open-source license & Unlock advanced features tailored for larger teams and enterprises with the EE License.

### **Hosting Options**

* **Cloud Hosting:** Hassle-free managed deployment at [app.salamruby.com](https://app.salamruby.com).
...
For licensing queries, contact us at [**hola@salamruby.com**]().

SalamRuby is designed to be intuitive and accessible, ensuring an easy setup no matter which option you choose. Start using SalamRuby today and take your surveys to the next level!

**Need Help?**
Join the conversation on [**GitHub Discussions**](https://github.com/salamruby/salamruby/discussions).