...
description: "Set up email functionality for your self-hosted SalamRuby instance"
icon: "envelope"
---

By default, SalamRuby doesn't include an SMTP server for sending emails. However, you can easily configure your self-hosted instance to use your own email provider through environment variables.

## Why Configure SMTP?

Setting up an SMTP server enables important email functionality in SalamRuby, including:
...
SalamRuby uses Nodemailer to send emails and supports various SMTP providers like:
...
By default, email verification and password reset features are **disabled** in SalamRuby. To enable these features:
