...
description: "Configure Microsoft Entra ID (Azure AD) OAuth for secure Single Sign-On with your SalamRuby instance. Use enterprise-grade authentication for your survey platform."
icon: "microsoft"
---

<Note>AzureAD OAuth is part of the SalamRuby [Enterprise Edition](/self-hosting/advanced/license)</Note>

### Microsoft Entra ID

Do you have a Microsoft Entra ID Tenant? Integrate it with your SalamRuby instance to allow users to log in using their existing Microsoft credentials. This guide will walk you through the process of setting up an Application Registration for your SalamRuby instance.
...
- A SalamRuby instance running and accessible.

- The callback URI for your SalamRuby instance: `{WEBAPP_URL}/api/auth/callback/azure-ad`

## How to connect your SalamRuby instance to Microsoft Entra
...
<Steps>
  ...
  <Step title="Configure the application">
    - Name your application something descriptive, such as `SalamRuby SSO`.
    ...
    - Under **Redirect URI**, select **Web** for the platform and paste your SalamRuby callback URI (see Requirements above).
  ...
  <Step title="Update environment variables">
    - Update these environment variables in your `docker-compose.yml` or pass it like your other environment variables to the SalamRuby container.
    ...
    An example `.env` for Microsoft Entra ID in SalamRuby would look like this:

    ```yml SalamRuby Env for Microsoft Entra ID SSO
