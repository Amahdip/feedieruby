...
Enabling the n8n integration in a self-hosted environment requires a new workflow setup using n8n and changing the environment variables of your SalamRuby instance.

* Setup your n8n workflow: Go to [n8n.io](https://n8n.io) and create a new workflow. Search for “SalamRuby” to get started:

![n8n](https://res.cloudinary.com/dwdb9tvii/image/upload/v1738252710/image_rp86wt.jpg)

* **Connect SalamRuby with n8n**: Now, you have to connect n8n with SalamRuby via an API Key:
...
Voila! You have successfully enabled the n8n integration in your self-hosted SalamRuby instance. Now you can follow the steps mentioned in the [SalamRuby](/xm-and-surveys/core-features/integrations/n8n) Integrations section to know more about the capabilities with SalamRuby with n8n.
