...
Enabling the Airtable Integration in a self-hosted environment requires creating an airtable account and changing the environment variables of your SalamRuby instance.
...
* Now just copy **Client ID** for your integration & add it to your **SalamRuby environment variables** as in the docker compose file:

* `AIRTABLE_CLIENT_ID`

Voila! You have successfully enabled the Airtable integration in your self-hosted SalamRuby instance. Now you can follow the steps mentioned in [Airtable Integration with SalamRuby](/xm-and-surveys/core-features/integrations/airtable) section to link an Airtable with SalamRuby.
