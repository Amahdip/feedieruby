...
## Setting Up ActivePieces with Self-Hosted SalamRuby

### Prerequisites
- A self-hosted SalamRuby instance
- Access to an ActivePieces account

### Configuration Steps

For general setup instructions, refer to our [comprehensive ActivePieces integration guide](https://salamruby.com/docs/xm-and-surveys/core-features/integrations/activepieces).
...
Instead of using `app.salamruby.com` as your `APP_URL`, you must substitute this with your own self-hosted SalamRuby instance URL.
...
- Ensure your self-hosted SalamRuby instance is accessible from the internet
