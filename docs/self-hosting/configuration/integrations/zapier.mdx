...
Setup your Zap: Go to [zapier.com](https://zapier.com/) and create a new Zap. Search for “SalamRuby” to get started:
...
Connect SalamRuby with Zapier: You have to connect Zapier with SalamRuby via an API Key:
...
Voila! You have successfully configured Zapier to work with your self-hosted SalamRuby instance. Now, you can follow the steps mentioned in the [Zapier Integration](https://salamruby.com/docs/developer-docs/integrations/zapier) section to connect it with your SalamRuby app and see it live.
