...
Integrating Google Sheets with a self-hosted SalamRuby instance requires configuring Google Cloud and updating your environment variables.
...
* Copy the Client ID and Client Secret and set them as environment variables in your SalamRuby instance:
...
Now just copy **GOOGLE\_SHEETS\_CLIENT\_ID**, **GOOGLE\_SHEETS\_CLIENT\_SECRET** and **GOOGLE\_SHEETS\_REDIRECT\_URL** for your integration & add it to your **SalamRuby environment variables** as in the docker compose file:
...
Voila! You have successfully enabled the Google Sheets integration in your self-hosted SalamRuby instance. Now you can follow the steps mentioned in [Google Sheets Integration with SalamRuby](/xm-and-surveys/core-features/integrations/google-sheets) section to link a Google Sheet with SalamRuby.
