...
**Do not** change the CSS variable names, as SalamRuby uses them to identify styling elements. You can adjust the values to fit your design. Below are sample values for reference:

```css
/* Overwrite SalamRuby default styles */
--fb-brand-color: red;
