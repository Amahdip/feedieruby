...
Spam protection feature protects your SalamRuby instance from spam and automated abuse by verifying that survey responses are submitted by real users. This guide explains how to enable and configure spam protection in your SalamRuby instance using Google reCAPTCHA v3.
...
2. Register a new site:
   - **Label:** Any name (e.g., "SalamRuby Self-Hosted")
...
If your self-hosted SalamRuby instance is behind a firewall or proxy, ensure it can reach the Google reCAPTCHA verification endpoint:
...
You can enable Google reCAPTCHA v3 spam protection for your survey directly from the SalamRuby Survey Editor. This helps prevent automated and spammy responses.
...
For help, join the conversation on [GitHub Discussions](https://github.com/salamruby/salamruby/discussions).
