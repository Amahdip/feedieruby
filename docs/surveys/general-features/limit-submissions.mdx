...
description: "Automatically close your survey after reaching a set number of responses in SalamRuby. This is useful for limited offers, exclusive surveys, or when you need a specific sample size."
icon: "lock"
---
