---
title: "Variables"
description: "Variables are a powerful feature in SalamRuby that allows you to keep track of data variables when user fills a form. This feature is especially useful when you want to use your survey as a quiz."
icon: "x"
---
...
1. **Setting**: Hidden fields can be set through query parameters or `salamruby.init`, but the variables can only be set either during creation or dynamically by using logic actions.
...
<Note>
  To know more about how to use logic in SalamRuby, check out the [Conditional
