...
```
https://salamruby.com/s/clin34bjy?screen=pricing
```

Multiple Hidden Fields:

```
https://salamruby.com/s/clin34bjy?screen=landing_page&job=Founder
```
...
```js
salamruby.track("action_name", {hiddenFields: {myField: "value"}})
```
