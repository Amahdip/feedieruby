...
<Note>
  **Self-Hosting Requirements**: This question type requires file upload storage to be configured. If you're
  self-hosting SalamRuby, make sure to [configure file uploads](/self-hosting/configuration/file-uploads)
  before using this feature.
</Note>

<iframe
  title="Survey Embed"
  src="https://app.salamruby.com/s/oo4e6vva48w0trn01ht8krwo"
  style={{
    position: "relative",
    height: "600px",
    maxHeight: "100vh",
