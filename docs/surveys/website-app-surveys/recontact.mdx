...
description: "Recontact options in SalamRuby enable you to manage how often and under what conditions a survey is shown to a user. This feature is crucial for balancing effective feedback collection with a positive user experience by preventing survey fatigue."
icon: "user-check"
---
...
- **Until they Submit a Response**: If tareting matches and trigger fires, SalamRuby keeps showing the survey until the user submits a response.
...
The Survey Cooldown is a universal blocker to make sure that no user sees too many surveys. This is particularly helpful when several teams of large organisations use SalamRuby at the same time.

<Note>The default Survey Cooldown is set to 7 days.</Note>

To adjust the Survey Cooldown:

1. Visit SalamRuby Settings
...
![SalamRuby Workspace-Wide Wait Time](/images/xm-and-surveys/surveys/website-app-surveys/recontact/global-wait-time.webp)
...
Still struggling or is something not working as expected? [Join us in Github Discussions](https://github.com/salamruby/salamruby/discussions) and we'd be glad to assist you!
