...
description: "App surveys deliver 6–10x higher conversion rates compared to email surveys. If you are new to SalamRuby, follow the steps in this guide to launch a survey in your web or mobile app (React Native) within 10–15 minutes."
icon: "rocket"
sidebarTitle: "Quickstart"
---

<Steps>
  <Step title="Create a SalamRuby cloud account">
    While you can [self-host](/self-hosting) SalamRuby, the fastest and easiest way to get started is with the free Cloud plan. Simply [sign up](https://app.salamruby.com/auth/signup) here, follow the onboarding steps, and choose the "SalamRuby Surveys" option.
  ...
  <Step title="Choose 'In-product surveys'">
    You can create In-product and Link Surveys with both options, but the onboarding will prompt you to connect your app/website to SalamRuby.
...
<Step title="Connect your App/Website">
  ...
  salamruby](https://res.cloudinary.com/dwdb9tvii/image/upload/v1738114328/image_tv0jmj.png)
</Step>

  <Step title="Confirm setup">
    As soon as SalamRuby receives the first data point, you will see a message in the onboarding:
  ...
  <Step title="Create trigger to show survey">
    Scroll to **Survey Trigger**, click **+ Add Action**, and select **Page View**. This ensures the survey appears when the SalamRuby Widget detects any page load.
...
<Step title="Understand caching behavior">
  For better scalability, we cache the request the SDK makes to the server. This allows you to use SalamRuby
  ...
  <Step title="Check browser compatibility">
    SalamRuby is designed to work with all modern browsers. Please ensure your users are using a supported version:
...
Need help? Join us in [**GitHub Discussions**](https://github.com/salamruby/salamruby/discussions), and we'll be happy to assist!
