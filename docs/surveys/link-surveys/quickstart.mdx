...
<Steps>
  <Step title="Create a free SalamRuby Cloud account">
    While you can [self-host](/self-hosting/overview) SalamRuby, the quickest and easiest way to get started is with the free Cloud plan. Just [sign up here](https://app.salamruby.com/auth/signup) and click through the onboarding.
  ...
  <Step title="Configure your survey settings">
    SalamRuby packs a lot of useful functionality out of the box. You can:
