...
| Column | Description |
|--------|-------------|
| **SalamRuby Contact ID** | Internal contact identifier (`contactId`) |
...
- **CSV storage**: Generated link lists are not retained in SalamRuby - download and store your CSV files securely
