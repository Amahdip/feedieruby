...
<Note>
  **Self-Hosted Only**: Pretty URLs are available exclusively on self-hosted SalamRuby instances. This feature is not available on SalamRuby Cloud.
</Note>
...
| Uniqueness | Must be unique across your entire SalamRuby instance |
