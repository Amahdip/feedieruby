...
description: "Mastering Churn Surveys with SalamRuby | Essential Tips & Steps"
...
1. Create new Churn Survey at [app.salamruby.com](https://app.salamruby.com/)
...
<Note>
  ### SalamRuby Widget running? We assume that you have already installed the

  SalamRuby Widget in your web app. It’s required to display messages and
...
Click on "Create Survey" and choose the template [Churn Survey](https://salamruby.com/survey-templates/churn-survey):
