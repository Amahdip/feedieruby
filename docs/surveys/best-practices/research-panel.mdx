...
description: "Build and manage your own research panel using SalamRuby to collect profiling data, create targeted segments, and distribute personalized survey links to panel members."
...
SalamRuby provides all the tools you need to build and manage a research panel:
...
<Steps>
  <Step title="Create a profiling survey">
    ...
    1. Go to [app.salamruby.com](https://app.salamruby.com) and click **Create Survey**
  ...
  <Step title="Download the example contact upload CSV">
    ...
    The example CSV shows you the format SalamRuby expects for contact uploads, including required fields like email and optional attribute columns.
  </Step>
  ...
  <Step title="Upload contacts to SalamRuby">
    Import your panel members into SalamRuby:
    ...
    Your panel members are now stored in SalamRuby with their profiling attributes.
  </Step>
