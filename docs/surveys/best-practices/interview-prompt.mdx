...
1. Create new Interview Prompt at [app.salamruby.com](https://app.salamruby.com/)
...
<Note>
  SalamRuby Widget running? We assume that you have already installed the SalamRuby Widget in your web app. It’s required to display messages and surveys in your app. If not, please follow the [Quick Start Guide (15mins)](/xm-and-surveys/surveys/website-app-surveys/quickstart)
</Note>
...
Click on "Create Survey" and choose the template [Interview Prompt](https://salamruby.com/survey-templates/interview-prompt):
