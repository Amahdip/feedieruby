---
title: "Feedback Box"
description: "A step-by-step guide to creating a feedback box using SalamRuby."
icon: "box"
---
...
1. Create new Feedback Box at app.salamruby.com
...
Then, create a new survey and look for the [Feedback Box template](https://salamruby.com/survey-templates/feedback-box):
...
<Note>SalamRuby Widget running? You need to have the SalamRuby Widget installed to display the Feedback Box in your app. Please follow [this tutorial (Step 4 onwards)](/xm-and-surveys/surveys/website-app-surveys/quickstart) to install the widget.</Note>