...
title: "Quiz Time"
icon: "brain"
description: "How to Create a Quiz Using SalamRuby - Step-by-Step Guide"
---

# Creating a quiz with SalamRuby - Step-by-step Guide

Welcome to this guide on creating engaging quizzes with SalamRuby! Quizzes help you capture customer insights, explore user personalities, or simply add fun for your team. With SalamRuby, you can personalize quizzes in minutes add scores, customize backgrounds, and more, all without any technical skills!
...
First, make sure you have a SalamRuby account. If not, you can create one [here](https://app.salamruby.com):
...
Congratulations! You’ve successfully created a Quiz with SalamRuby. You can play around with the quiz that we just created [here](https://app.salamruby.com/s/cm2wwt3vu0001ir8o7ys0bezz).

A great quiz can serve as an excellent lead generator, a job fit checker, or just a fun icebreaker for your team. You now have the skills to build that! If you want to read more about building quizzes and how you can create a Job Fit Quiz check this article [here](https://www.harshbhat.me/blog/salamruby-quiz).
