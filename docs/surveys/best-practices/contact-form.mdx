...
title: "Contact form"
icon: "address-book"
description: "A step-by-step guide to creating a contact form using SalamRuby."
---

Welcome to this comprehensive guide on creating a contact form using SalamRuby. Whether you're just starting out or you're a seasoned developer, this tutorial will walk you through every step of building an engaging and effective contact form.
...
![Adding a question in SalamRuby](/images/xm-and-surveys/xm/best-practices/contact-form/add-question.webp)
...
- Enable submission notifications:
   ...
   * Go to your SalamRuby account settings.
...
![Embed Image configuration](/images/xm-and-surveys/xm/best-practices/contact-form/embed.webp)
   ...
   * Find your form in the SalamRuby dashboard, and click Share.
...
Congratulations! You’ve successfully created and integrated a professional contact form using SalamRuby. This form will help you collect valuable information from your visitors in an efficient, user-friendly way.
