---
title: "Understanding SalamRuby Survey Types"
sidebarTitle: "Survey Types 101"
description: "This guide explains the differences between SalamRuby Link Surveys and Website & App Surveys to help you choose the right option."
...
| **Segmentation** | You control externally | Built-in via SalamRuby |
...
```
https://app.salamruby.com/s/<surveyId>?embed=true&userId=123
```
...
window.addEventListener("message", (event) => {
  if (event.data === "salamrubySurveyCompleted") {
    closeWebView();
  }
});
```
...
- You don't need SalamRuby attribute-based targeting & survey fatigue controls


## Website & App Surveys (SDK)

Also known as **intercept surveys**. Requires SDK integration. SalamRuby handles targeting, triggering, and survey fatigue.
...
- You want SalamRuby to handle who sees which survey
...
**Need help?** [Join us in GitHub Discussions](https://github.com/salamruby/salamruby/discussions)
