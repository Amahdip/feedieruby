...
**SalamRuby Hub** is SalamRuby' unified feedback data layer. It stores normalized feedback from multiple input channels so teams can query, analyze, and act on it in one place.
...
To learn more, visit the Hub docs at [hub.salamruby.com](https://hub.salamruby.com) and the [Hub API Reference](https://hub.salamruby.com/api).
