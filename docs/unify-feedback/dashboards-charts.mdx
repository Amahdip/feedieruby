...
Describe what you want in natural language ("Average NPS by month over the last 90 days") and SalamRuby generates the Cube query for you. You can edit the result in the manual builder afterwards.
