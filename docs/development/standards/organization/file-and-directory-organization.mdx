...
description: This document outlines the structure and organization of files and directories in the SalamRuby codebase, providing guidelines for maintaining consistency and clarity across the repository.
icon: folder-tree
---

## Repository Structure Overview

The SalamRuby codebase follows a monorepo structure using pnpm workspaces, with two main directories:
...
* Main SalamRuby web application (Next.js)
...
* Showcases SalamRuby in-product surveying functionality
