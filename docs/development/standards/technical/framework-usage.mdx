...
description: Guidelines on how SalamRuby utilizes Next.js, Tailwind CSS, and Prisma ORM for efficient development and performance.
icon: book
---

## Introduction

This document outlines the framework usage guidelines for SalamRuby, which is built primarily on Next.js (with heavy use of Server-Side Rendering through the App Router), Tailwind CSS, and Prisma ORM. 
