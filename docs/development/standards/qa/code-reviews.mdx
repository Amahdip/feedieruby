---
title: Code Reviews
description: This document outlines our comprehensive code review process at SalamRuby. We maintain high quality, consistency, and best practices within our codebase through this structured approach.
icon: eyes
---
...
> **Note:** At SalamRuby, all feature changes must be submitted through Pull Requests - direct pushes to protected branches are not allowed.
