---
title: "Documentation"
description: "Standards for documenting code and features in the SalamRuby codebase"
icon: "book"
---

## Overview

At SalamRuby, we maintain strict documentation standards to ensure code clarity, maintainability, and ease of use for both internal developers and external contributors.

### Contribute to Documentation

We use Mintlify to maintain our documentation. You can find more information about how to contribute to the documentation in the [README](https://github.com/salamruby/salamruby/blob/main/docs/README.md) file.
...
void window.salamruby.setup(...args);
```
