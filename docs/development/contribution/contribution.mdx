---
title: "Contribute to SalamRuby"
description: "How to contribute to SalamRuby"
icon: "code"
---

We’re excited that you want to contribute to SalamRuby! There are many ways to help, including reporting issues, fixing bugs, adding new features, or improving documentation.
...
We highly recommend engaging with us on [**GitHub Discussions**](https://github.com/salamruby/salamruby/discussions) before submitting contributions.
This helps improve the chances of your PR being accepted while avoiding unnecessary work.

#### Contributor License Agreement (CLA)

To keep SalamRuby sustainable, we require a **CLA** from all contributors.
