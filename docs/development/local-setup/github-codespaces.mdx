...
description: How to set up SalamRuby in a GitHub Codespaces environment
icon: "github"
---

### GitHub Codespaces Setup

<Info>This guide outlines how to set up SalamRuby in a **GitHub Codespaces** environment.</Info>
...
Use the Codespaces port forwarding to access SalamRuby at [http://localhost:3000](http://localhost:3000).
