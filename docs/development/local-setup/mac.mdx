---
title: Mac
description: How to set up SalamRuby on a Mac machine
icon: "apple"
---

### Local Machine Setup - Mac

<Info>This guide is recommended for advanced users setting up SalamRuby on a **Mac** machine.</Info>
...
Visit [http://localhost:3000](http://localhost:3000) to access SalamRuby.
